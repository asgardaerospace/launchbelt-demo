...
import LaunchbeltLogo from './components/LaunchbeltLogo';
...
import { Box, Shield, Globe, Scan } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  // Update theme colors when current module changes
  useEffect(() => {
    if (currentModule) {
  ...
  // If user hasn't entered the demo yet, show the landing page
  if (!hasEnteredDemo) {
